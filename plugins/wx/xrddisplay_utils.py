...
#from larch_plugins.xrd import (xrd_background, xrd_calib_fitrois,
#                               xrd_calib_compute, xrd_calib_apply)

class XRDCalibrationFrame(wx.Frame):
...
##        xrd_calib_fitrois(mca, _larch=self.larch)
...
##        xrd_calib_compute(mca, apply=True, _larch=self.larch)
...
##        xrd_calib_apply(mca, offset=old_calib[0], slope=old_calib[1],
##                        _larch=self.larch)
...
##        xrd_calib_apply(mca, offset=offset, slope=slope, _larch=self.larch)
...
class ColorsFrame(wx.Frame):
    ...
    def __init__(self, parent, size=(400, 300), **kws):
        ...
        panel.AddText('    XRD Display Colors', dcol=4, colour='#880000')
        ...
        scolor(' XRD Background:',      'bgr_color')
