...
def mda2ascii(filename, dim=1):
    """convert mda file to ASCII, in ASCII subdirectory

    mda2ascii(filename, dim=1)

    where dim is dimension of scan
    """
    mdadata = readMDA(filename)
