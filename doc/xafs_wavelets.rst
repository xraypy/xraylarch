...
.. subfigure:: AB
   ...
   .. image::  _images/xwt_mag.png
      :width: 100%

   .. image::  _images/xwt_re.png
      :width: 100%

   The Cauchy Wavelet transforms, with magnitude on the left hand
   panel and real part on the right hand panel.
...
.. subfigure:: AB
   ...
   .. image::  _images/xwt_ksp.png
      :width: 100%
   .. image::  _images/xwt_rsp.png
      :width: 100%

   The Cauchy Wavelet transform projected to :math:`k` and :math:`R`
   space.  In the left hand panel, the original EXAFS
   :math:`k^2\chi(k)` is shown for comparison.
