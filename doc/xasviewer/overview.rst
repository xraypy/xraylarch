...
===================================
   ...
   * FEFF input Generator from general structure (cif, VASP, xyz, Gaussian, and etc are supported. Installation of openbabel is required for some formats. See :ref:`install-conda`).
