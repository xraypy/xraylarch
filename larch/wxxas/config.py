...
exafs = [CVar('rbkg', 1.0, 'float', min=0, step=0.1, max=10, desc='R value separating background from EXAFS signal'),
         ...
         CVar('bkg_clamplo', 1, 'int', min=0, step=5, desc='low-k clamp for background subtraction'),
         CVar('bkg_clamphi', 20, 'int', min=0, step=5, desc='high-k clamp for background subtraction'),
