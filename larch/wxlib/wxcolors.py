#!/usr/bin/python
"""
wx colors, copied (2025-March) from wxutils and wxmplot
...
COLORS_LIGHT = {'text': wx.Colour(0, 0, 0),
          ...
          'text_unused': wx.Colour(180, 180, 30),
          ...
          'title_green': wx.Colour(10, 120, 10),
...
COLORS_DARK = {'text': wx.Colour(255, 255, 255),
             ...
             'title_red': wx.Colour(253,100,100),
             'title_blue': wx.Colour(100,100,253),
             'title_green': wx.Colour(100,253,100),
             'pvname': wx.Colour(10,10,80),
