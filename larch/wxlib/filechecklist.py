...
from wxutils import EditableListBox as EListBox
from wxutils.colors import (get_color, add_named_color,
                            register_darkdetect)

add_named_color('elist_bg',  (255, 255, 250, 255), (25, 25, 25, 255))
add_named_color('elist_fg', (10, 10, 50, 255), (120, 120, 250, 255))
...
class EditableListBox(wx.ListBox):
    ...
    def __init__(self, parent, select_action, right_click=True,
        ...
        if color is None:
            color = get_color('elist_fg')
        if bgcolor is None:
            bgcolor = get_color('elist_bg')
    ...
    def onDarkTheme(self, is_dark=None):
        color = get_color('elist_fg', dark=is_dark)
        bgcolor = get_color('elist_bg', dark=is_dark)
        self.SetBackgroundColour(bgcolor)
        self.SetOwnBackgroundColour(bgcolor)
        self.SetForegroundColour(color)
        self.SetOwnForegroundColour(color)
