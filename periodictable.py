...
class PeriodicTablePanel(wx.Panel):
    ...
    FRAME_BG = (253, 253, 200)
    TITLE_BG = (253, 253, 200)
    REG_BG   = (80, 80, 150)
    REG_FG   = (80, 80, 150)
    ...
    def __init__(self, parent, title='Select Element',
        ...
        self.selected = None
        self.elemfont  = wx.Font(10, wx.DEFAULT, wx.NORMAL, wx.BOLD, 0, "")
    ...
    def BuildPanel(self):
        ...
        for name, coords in self.elems.items():
            wid = wx.NewId()
            tw = wx.StaticText(self, wid, label=name, size=(20, 35))
        ...
        print "SIZE ", ix, iy ,  self.GetBestSize()
        sizer.Fit(self)
