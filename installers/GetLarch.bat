...
call %prefix%\Scripts\mamba install -yc conda-forge python==3.11.5 numpy scipy matplotlib scikit-image scikit-learn pycifrw pandas jupyter plotly wxpython fabio pyfai pymatgen mkl_fft tomopy
