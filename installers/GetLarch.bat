...
call %prefix%\Scripts\conda install -yc conda-forge python==3.13.13 numpy=>2.2.0 scipy=>1.15 matplotlib=>3.10 h5py=>3.13 wxpython=>4.3.1 mkl_fft spglib=>2.7.0 pymatgen
