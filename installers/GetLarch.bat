...
call %prefix%\Scripts\conda install -yc conda-forge python==3.13.10 numpy=>2.2.0 scipy=>1.15 matplotlib=>3.10 h5py=>3.12 wxpython=>4.2.4 mkl_fft spglib=>2.7.0 pymatgen
