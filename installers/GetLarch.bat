...
call %prefix%\Scripts\conda install -yc conda-forge python==3.13.10 numpy=>2.3.0 scipy=>1.16 matplotlib=>3.10 h5py=>3.13 wxpython=>4.2.4 mkl_fft spglib=>2.7.0 pymatgen
